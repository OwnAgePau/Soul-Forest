...
public class SoulBlocks {
    ...
    public static Optional<? extends Block> PorphyryBrickStairs                         = Optional.absent();
    public static Optional<? extends Block> SlateBrickStairs                         = Optional.absent();
    public static Optional<? extends Block> TitaniumBrickStairs                         = Optional.absent();
