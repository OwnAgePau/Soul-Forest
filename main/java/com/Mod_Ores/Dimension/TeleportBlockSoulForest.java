...
public class TeleportBlockSoulForest extends BlockBreakable
{
    ...
    public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
    {
        ...
        if (par1World.getBlock(par2 - 1, par3, par4) == SoulBlocks.SilverBlock.get() || par1World.getBlock(par2 + 1, par3, par4) == SoulBlocks.SilverBlock.get())
        {
            b0 = 1;
        }

        if (par1World.getBlock(par2, par3, par4 - 1) == SoulBlocks.SilverBlock.get() || par1World.getBlock(par2, par3, par4 + 1) == SoulBlocks.SilverBlock.get())
        {
            b1 = 1;
        }
            ...
            for (l = -1; l <= 2; ++l)
            {
                for (i1 = -1; i1 <= 3; ++i1)
                {
                    ...
                    if (l != -1 && l != 2 || i1 != -1 && i1 != 3)
                    {
                        ...
                        if (flag)
                        {
                            if (j1 != SoulBlocks.SilverBlock.get())
                            {
                                return false;
                            }
                        }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (par1World.getBlock(par2, i1 - 1, par4) != SoulBlocks.SilverBlock.get())
        {
        ...
        else
        {
            ...
            if (j1 == 3 && par1World.getBlock(par2, i1 + j1, par4) == SoulBlocks.SilverBlock.get())
            {
                ...
                {
                    if ((par1World.getBlock(par2 + b0, par3, par4 + b1) != SoulBlocks.SilverBlock.get() || par1World.getBlock(par2 - b0, par3, par4 - b1) != this) && (par1World.getBlock(par2 - b0, par3, par4 - b1) != SoulBlocks.SilverBlock.get() || par1World.getBlock(par2 + b0, par3, par4 + b1) != this))
                    {
                        par1World.setBlockToAir(par2, par3, par4);
                    }
                }
