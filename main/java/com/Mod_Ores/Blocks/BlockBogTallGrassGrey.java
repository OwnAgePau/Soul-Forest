...
public class BlockBogTallGrassGrey extends BlockFlower implements IScollectable
{
    private static final String[] grassTypes = new String[] {"Bog_grass_tall_grey"};
    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;

    public BlockBogTallGrassGrey(String Unlname)
    {
        super(0);
        float f = 0.4F;
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon("soulforest:Bog_grass_tall_grey");
        }
    }
