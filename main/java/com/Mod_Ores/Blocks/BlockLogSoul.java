...
public class BlockLogSoul extends Block
{
     ...
     */
    public BlockLogSoul(String Unlname, float Hardness)
    {
        super(Material.wood);
    ...
    {
    	this.tree_top = par1IconRegister.registerIcon("soulforest:SoulLog_top");
    	
        this.iconArray = new IIcon[2];

        for (int i = 0; i < 2; ++i)
        {
            this.iconArray[i] = par1IconRegister.registerIcon("soulforest:SoulLog");
        }
    }
