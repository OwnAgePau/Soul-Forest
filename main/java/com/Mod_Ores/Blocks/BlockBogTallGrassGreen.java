...
public class BlockBogTallGrassGreen extends BlockFlower implements IScollectable
{
    private static final String[] grassTypes = new String[] {"Bog_grass_tall_green"};
    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;

    public BlockBogTallGrassGreen(String Unlname)
    {
	super(0);
	float f = 0.4F;
	...
	{
	    this.iconArray[i] = par1IconRegister.registerIcon("soulforest:Bog_grass_tall_green");
	}
    }
