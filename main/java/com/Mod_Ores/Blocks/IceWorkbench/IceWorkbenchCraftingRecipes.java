...
public class IceWorkbenchCraftingRecipes{
    ...
    private IceWorkbenchCraftingRecipes(){
    	...
    	this.addRecipe(new ItemStack(SoulItems.BurnedMagicFragment.get(), 2), new Object[] {"#BB#", "SCCS", "SCCS", "%BB%", '#', SoulBlocks.ScarletiteBlock.get(), '%', SoulBlocks.ScarletiteBlock.get(), 'B', SoulItems.BurnedShard.get(), 'S', SoulItems.BurnedShard.get(), 'C', SoulItems.MithrilIngot.get()});
    	...
    	this.addRecipe(new ItemStack(SoulItems.FrozenMagicFragment.get(), 2), new Object[] {"#BB#", "SCCS", "SCCS", "%BB%", '#', SoulBlocks.AquamarineBlock.get(), '%', SoulBlocks.AquamarineBlock.get(), 'B', SoulItems.FrostShard.get(), 'S', SoulItems.FrostShard.get(), 'C', SoulItems.MithrilIngot.get()});  
    	...
    	this.addRecipe(new ItemStack(SoulItems.EnlightedMagicFragment.get(), 2), new Object[] {"#BB#", "SCCS", "SCCS", "%BB%", '#', SoulBlocks.CitrineBlock.get(), '%', SoulBlocks.CitrineBlock.get(), 'B', SoulItems.LightShard.get(), 'S', SoulItems.LightShard.get(), 'C', SoulItems.MithrilIngot.get()});  
    	...
    	this.addRecipe(new ItemStack(SoulItems.BurnedMagicFragmentAdv.get(), 2), new Object[] {"#BB#", "SCCS", "SCCS", "%BB%", '#', SoulBlocks.ScarletiteBlock.get(), '%', SoulBlocks.ScarletiteBlock.get(), 'B', SoulItems.BurnedFragment.get(), 'S', SoulItems.BurnedFragment.get(), 'C', SoulItems.MithrilIngot.get()});
    	...
    	this.addRecipe(new ItemStack(SoulItems.FrozenMagicFragmentAdv.get(), 2), new Object[] {"#BB#", "SCCS", "SCCS", "%BB%", '#', SoulBlocks.AquamarineBlock.get(), '%', SoulBlocks.AquamarineBlock.get(), 'B', SoulItems.FrostFragment.get(), 'S', SoulItems.FrostFragment.get(), 'C', SoulItems.MithrilIngot.get()});  
    	...
    	this.addRecipe(new ItemStack(SoulItems.EnlightedMagicFragmentAdv.get(), 2), new Object[] {"#BB#", "SCCS", "SCCS", "%BB%", '#', SoulBlocks.SilverBlock.get(), '%', SoulBlocks.SilverBlock.get(), 'B', SoulItems.LightFragment.get(), 'S', SoulItems.LightFragment.get(), 'C', SoulItems.MithrilIngot.get()});  
