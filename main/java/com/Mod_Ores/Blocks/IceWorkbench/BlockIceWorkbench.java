...
public class BlockIceWorkbench extends Block
{
	...
	return par1 == 1 ? this.workbenchIconTop : (par1 == 0 ? Block.getBlockFromName("planks").getBlockTextureFromSide(par1) : (par1 != 2 && par1 != 4 ? this.blockIcon : this.workbenchIconFront));
    }
	...
	if (i != SoulBlocks.IceWorkbench.get() || player.isSneaking()) {
	    return false;
	}

	player.openGui(soul_forest.instance, 1, world, x, y, z);
	return true;
    }
}
