...
public class BlockFrozenTallGrass extends BlockFlower implements IScollectable
{
    private static final String[] grassTypes = new String[] {"Frozen_tallgrass"};
    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;

    public BlockFrozenTallGrass(String Unlname)
    {
	super(0);
	float f = 0.4F;
    ...
    {
	return par1 == SoulBlocks.FrozenGrass.get() || par1 == SoulBlocks.BogDirt.get();
    }
	...
	{
	    this.iconArray[i] = par1IconRegister.registerIcon("soulforest:Frozen_tallgrass");
	}
    }
