...
public class GuiGemmerationTable extends GuiContainer{	
    ...
    public GuiGemmerationTable(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5){
        super(new ContainerGemmeration(par1InventoryPlayer, par2World, par3, par4, par5));
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2){
        this.fontRendererObj.drawString("Gemmmeration Table", 42, 6, 0x000000);
