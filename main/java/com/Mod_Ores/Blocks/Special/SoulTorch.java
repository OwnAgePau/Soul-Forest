...
{
	public String unlName;
    public SoulTorch(String par2UnlName)
    {
        super();
		//setUnlocalizedName(par2UnlName);
		this.unlName = par2UnlName;
    ...
    {
        return par1World.isSideSolid(par2 - 1, par3, par4, ForgeDirection.EAST,  true) ||
               par1World.isSideSolid(par2 + 1, par3, par4, ForgeDirection.WEST,  true) ||
               par1World.isSideSolid(par2, par3, par4 - 1, ForgeDirection.SOUTH, true) ||
               par1World.isSideSolid(par2, par3, par4 + 1, ForgeDirection.NORTH, true) ||
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
    	...
    	EnumTorchHelper helper = new EnumTorchHelper();
    	helper.getTorchColours(this.unlName);
    	
        if (l == 1)
        {
            par1World.spawnParticle("smoke", d0 - d4, d1 + d3 + 0.1, d2, 0.0D, 0.0D, 0.0D);           
            par1World.spawnParticle("flame", d0 - d4, d1 + d3 + 0.1, d2, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 2)
        {
            par1World.spawnParticle("smoke", d0 + d4, d1 + d3 + 0.1, d2, 0.0D, 0.0D, 0.0D);
        ...
        {
            par1World.spawnParticle("smoke", d0, d1 + d3 + 0.1, d2 - d4, 0.0D, 0.0D, 0.0D);
            par1World.spawnParticle("flame", d0, d1 + d3 + 0.1, d2 - d4, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 4)
        {
            par1World.spawnParticle("smoke", d0, d1 + d3 + 0.1, d2 + d4, 0.0D, 0.0D, 0.0D);
        ...
        {
            par1World.spawnParticle("smoke", d0, d1 + 0.1, d2, 0.0D, 0.0D, 0.0D);
            par1World.spawnParticle("flame", d0, d1 + 0.1, d2, 0.0D, 0.0D, 0.0D);
        }
    }
}
