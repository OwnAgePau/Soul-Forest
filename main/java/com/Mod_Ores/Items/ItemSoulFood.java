...
public class ItemSoulFood extends ItemFood
{
     ...
     * @param par2duration the duration of the itemUse
     * @param par3healAmmount the heal amount of the item
     * @param par4saturation the saturation modifier
     * @param par5WolfsFavMeat true = wolves favorite meat
