...
public class RenderFrostShard extends Render
{
    ...
    public RenderFrostShard(Item p_i1259_1_, int p_i1259_2_)
    {
	this.item = p_i1259_1_;
	this.itemDamage = p_i1259_2_;
    }
	...
	return getCustomTexture((EntityFrostShard) entity);
    }

    private ResourceLocation getCustomTexture(EntityFrostShard entity) {
	return this.texture;
    }
