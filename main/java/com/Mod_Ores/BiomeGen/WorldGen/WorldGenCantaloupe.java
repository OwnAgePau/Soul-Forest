        ...
        for (int l = 0; l < 64; ++l)
        {
            ...
            if (par1World.isAirBlock(i1, j1, k1) && this.plantBlock.canBlockStay(par1World, i1, j1, k1) && !par1World.isAirBlock(i1, (j1 - 1), k1))
            {
            	if(par1World.getBlock(i1, j1 - 1, k1) != SoulBlocks.SoulWaterMoving.get()
            			...
            			&& par1World.getBlock(i1, j1 - 1, k1) != SoulBlocks.SoulLeavesBlue.get()
            			&& par1World.getBlock(i1, j1 - 1, k1) != SoulBlocks.SoulLeavesOrange.get()
            			&& par1World.getBlock(i1, j1 - 1, k1) != SoulBlocks.SoulLeavesPink.get()
