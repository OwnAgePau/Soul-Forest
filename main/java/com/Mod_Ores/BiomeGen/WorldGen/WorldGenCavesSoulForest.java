...
public class WorldGenCavesSoulForest extends MapGenBase{
                        ...
                        for (int l2 = k4; !flag2 && l2 < j2; ++l2){
                            for (int i3 = i2 + 1; !flag2 && i3 >= j4 - 1; --i3){
                                ...
                                if (i3 >= 0 && i3 < 128){
                                    ...
                                    if (block == SoulBlocks.SoulWaterMoving.get()){
                                        flag2 = true;
                                    }
                            ...
                            for (j3 = k4; j3 < j2; ++j3){
                                ...
                                for (int l3 = i2 - 1; l3 >= j4; --l3){
                                    ...
                                    if (d12 > -0.7D && d13 * d13 + d12 * d12 + d14 * d14 < 1.0D){
                                        ...
                                        if (block1 == SoulBlocks.Porphyry.get() || block1 == SoulBlocks.Slate.get() || block1 == SoulBlocks.Bauxite.get() || block1 == SoulBlocks.BogDirt.get() || block1 == SoulBlocks.BogGrass.get() || block1 == SoulBlocks.LateriteDirt.get() || block1 == SoulBlocks.LateriteGrass.get() || block1 == SoulBlocks.FyrisedSand.get() || block1 == SoulBlocks.FyrisedSandGrass.get() || block1 == SoulBlocks.SoulSnowBottom.get() || block1 == SoulBlocks.SoulSnowTop.get() || block1 == SoulBlocks.FrozenGrass.get()){
                                            p_151543_5_[k3] = null;
                                        }
                                    }
