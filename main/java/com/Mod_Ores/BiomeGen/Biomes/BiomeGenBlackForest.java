...
public class BiomeGenBlackForest extends BiomeGenBase
{
    ...
    public BiomeGenBlackForest(int par1)
    {
        ...
        System.out.println(SoulConfigCreatures.furivoliSpawnFreq);
        System.out.println(SoulConfigCreatures.furivoliMinGroup);
        System.out.println(SoulConfigCreatures.furivoliMaxGroup);
