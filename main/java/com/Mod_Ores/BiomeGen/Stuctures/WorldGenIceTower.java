...
public class WorldGenIceTower extends WorldGenerator{
	...
	public boolean generate(World world, Random random, int x, int y, int z){
		...
		if (l != SoulBlocks.SoulSnowTop.get()){
			return false;
		}
		//Ice Tower
		int x1 = 0;
		...
		for(x1 = 0; x1 < width; ++x1){
			for(y1 = -1; y1 < height; ++y1){
				world.setBlock(x + x1, y + y1, z, SoulBlocks.IceBrick.get());
				world.setBlock(x + x1, y + y1, z + 6, SoulBlocks.IceBrick.get());
			}     	
		}
		...
		for(z1 = 0; z1 < width; ++z1){
			for(y1 = -1; y1 < height; ++y1){
				world.setBlock(x, y + y1, z + z1, SoulBlocks.IceBrick.get());
				world.setBlock(x + 6, y + y1, z + z1, SoulBlocks.IceBrick.get());
			}     
		}
		...
		for(x1 = 0; x1 < width; ++x1){
			for(z1 = 0; z1 < width; ++z1){
				world.setBlock(x + x1, y, z + z1, SoulBlocks.IceBrick.get());
				world.setBlock(x + x1, y + 6, z + z1, SoulBlocks.IceBrick.get());
				world.setBlock(x + x1, y + (height), z + z1, SoulBlocks.IceBrick.get());
			}
		}
		...
		for(x1 = 0; x1 < width; ++x1){
			for(z1 = 0; z1 < width; ++z1){
				for(y1 = height; y1 < (height + 1); ++y1){
					world.setBlock(x + x1, y + y1, z + z1, SoulBlocks.IceBrick.get());
				}
			}
		}
		for(int xStep = 0; xStep < 6; xStep+=2){
			world.setBlock(x + xStep, y + (height + 2), z, SoulBlocks.IceBrick.get());
			world.setBlock(x + xStep, y + (height + 2), z + 6, SoulBlocks.IceBrick.get());
		}
		for(int zStep = 0; zStep <= 6; zStep+=2){
			world.setBlock(x, y + (height + 2), z + zStep, SoulBlocks.IceBrick.get());
			world.setBlock(x + 6, y + (height + 2), z + zStep, SoulBlocks.IceBrick.get());
		}
		/*world.setBlock(x, y + (height + 2), z, SoulBlocks.IceBrick.get());
		world.setBlock(x + 2, y + (height + 2), z, SoulBlocks.IceBrick.get());
		world.setBlock(x + 4, y + (height + 2), z, SoulBlocks.IceBrick.get());
		world.setBlock(x + 6, y + (height + 2), z, SoulBlocks.IceBrick.get());

		world.setBlock(x, y + (height + 2), z + 6, SoulBlocks.IceBrick.get());
		world.setBlock(x + 2, y + (height + 2), z + 6, SoulBlocks.IceBrick.get());
		world.setBlock(x + 4, y + (height + 2), z + 6, SoulBlocks.IceBrick.get());
		world.setBlock(x + 6, y + (height + 2), z + 6, SoulBlocks.IceBrick.get());

		world.setBlock(x, y + (height + 2), z, SoulBlocks.IceBrick.get());
		world.setBlock(x, y + (height + 2), z + 2, SoulBlocks.IceBrick.get());
		world.setBlock(x, y + (height + 2), z + 4, SoulBlocks.IceBrick.get());
		world.setBlock(x, y + (height + 2), z + 6, SoulBlocks.IceBrick.get());

		world.setBlock(x + 6, y + (height + 2), z, SoulBlocks.IceBrick.get());
		world.setBlock(x + 6, y + (height + 2), z + 2, SoulBlocks.IceBrick.get());
		world.setBlock(x + 6, y + (height + 2), z + 4, SoulBlocks.IceBrick.get());
		world.setBlock(x + 6, y + (height + 2), z + 6, SoulBlocks.IceBrick.get());*/

		//Roof (top most layer)
		for(x1 = 0; x1 < width; ++x1){
			world.setBlock(x + x1, y + (height + 1), z, SoulBlocks.IceBrick.get());
			world.setBlock(x + x1, y + (height + 1), z + 6, SoulBlocks.IceBrick.get()); 
		}

		//Floors
		for(z1 = 0; z1 < width; ++z1){
			world.setBlock(x, y + (height + 1), z + z1, SoulBlocks.IceBrick.get());
			world.setBlock(x + 6, y + (height + 1), z + z1, SoulBlocks.IceBrick.get()); 
		}
		...
		if(sides.size() > 0){
			...
			if(random.nextInt(4) == 0){
				...
				if(side == 0){
					this.spawnChestRoom(world, random, x, y - 4, z - 13, 5, SoulBlocks.IceBrick.get(), 2, true);
				}
				else if(side == 1){
					this.spawnChestRoom(world, random, x + 13, y - 4, z, 5, SoulBlocks.IceBrick.get(), 3, true);
				}
				else if(side == 2){
					this.spawnChestRoom(world, random, x, y - 4, z + 13, 5, SoulBlocks.IceBrick.get(), 0, true);
				}
				else if(side == 3){
					this.spawnChestRoom(world, random, x - 13, y - 4, z, 5, SoulBlocks.IceBrick.get(), 1, true);
				}
			}
		}
		...
		if(side == 0){
			...
			for(int z1 = startZ; z1 > -difZ; z1--){
				for(int x1 = startX; x1 < difX; x1++){
					...
					for(int y1 = startY; y1 > -5; y1--){
						world.setBlock(x + 1, y + y1, z + z1, SoulBlocks.IceBrick.get());	
						world.setBlock(x + difX, y + y1, z + z1, SoulBlocks.IceBrick.get());	
					}	
					world.setBlock(x + x1, y - 4, z + z1, SoulBlocks.IceBrick.get());
					world.setBlock(x + x1, y + startY + 1, z + z1, SoulBlocks.IceBrick.get());
					for(int y1 = startY - 5; y1 > -4; y1--){
						world.setBlock(x + x1, y + y1, z + z1, SoulBlocks.IceBrick.get());
					}
					if(startY - 5 > -5){
						world.setBlock(x + x1, y + (startY - 4), z + z1, SoulBlocks.IceBrickStairs.get(), Direction.facingToDirection[2], 2);
					}
				}
				if(startY >= 0){
					startY--;
			...
			for(int x1 = startX; x1 < difX; x1++){
				for(int z1 = startZ; z1 < difZ; z1++){
					...
					for(int y1 = startY; y1 > -5; y1--){
						world.setBlock(x + x1, y + y1, z + 1, SoulBlocks.IceBrick.get());	
						world.setBlock(x + x1, y + y1, z + difZ, SoulBlocks.IceBrick.get());
					}	
					world.setBlock(x + x1, y - 4, z + z1, SoulBlocks.IceBrick.get());
					world.setBlock(x + x1, y + startY + 1, z + z1, SoulBlocks.IceBrick.get());
					for(int y1 = startY - 5; y1 > -4; y1--){
					...
					if(startY - 5 > -5){
						world.setBlock(x + x1, y + (startY - 4), z + z1, SoulBlocks.IceBrickStairs.get(), Direction.facingToDirection[4], 2);
					}
				}
				if(startY >= 0){
					startY--;
			...
			for(int z1 = startZ; z1 < difZ; z1++){
				for(int x1 = startX; x1 < difX; x1++){
					...
					if(startY - 5 > -5){
						world.setBlock(x + x1, y + (startY - 4), z + z1, SoulBlocks.IceBrickStairs.get(), Direction.facingToDirection[5], 2);
					}
				}
				if(startY >= 0){
					startY--;
			...
			for(int x1 = startX; x1 > -difX; x1--){
				for(int z1 = startZ; z1 < difZ; z1++){
					...
					if(startY - 5 > -5){
						world.setBlock(x + x1, y + (startY - 4), z + z1, SoulBlocks.IceBrickStairs.get(), Direction.facingToDirection[3], 2);
					}
				}
				if(startY >= 0){
					startY--;
