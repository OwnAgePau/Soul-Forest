...
public class GenLayerBiomeZoom extends GenLayerSoulForest{
    public GenLayerBiomeZoom(long par1, GenLayerSoulForest par3GenLayer){
	super(par1);
    ...
    public static GenLayerSoulForest magnify(long par0, GenLayerSoulForest par2GenLayer, int par3){
	Object object = par2GenLayer;

	for (int k = 0; k < par3; ++k){
	    object = new GenLayerBiomeZoom(par0 + k, (GenLayerSoulForest)object);
	}
	return (GenLayerSoulForest)object;
    }
}