...
public class TeleporterFrozenHearth extends Teleporter{
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8){
        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(k1, i2, l1) == SoulBlocks.TeleporterFrozenHearth.get())
                        {
                            while (this.worldServerInstance.getBlock(k1, i2 - 1, l1) == SoulBlocks.TeleporterFrozenHearth.get())
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == SoulBlocks.TeleporterFrozenHearth.get())
            {
                j2 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == SoulBlocks.TeleporterFrozenHearth.get())
            {
                j2 = 3;
            }
