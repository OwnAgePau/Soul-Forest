...
public class ChunkProviderFrozenHearth implements IChunkProvider{
				    ...
				    for (int l1 = 0; l1 < 8; ++l1){
						...
						for (int i2 = 0; i2 < 4; ++i2){
						    ...
						    for (int k2 = 0; k2 < 4; ++k2){
								...
								if(k1 * 8 + l1 == 31){
								    block = SoulBlocks.SoulIce.get().getDefaultState();
								}
								...
								// TODO Niemand weet, niemand weet, of die wel goed is
								int l2 = j2 + j1 * 4;
                                int i3 = i2 + l1 * 8;
                                int j3 = k2 + k1 * 4;
    ...
    public void replaceBiomeBlocks(int p_147418_1_, int p_147418_2_, ChunkPrimer primer, BiomeGenBase[] biomes){
		...
		for (int k = 0; k < 16; ++k){
		    for (int l = 0; l < 16; ++l){
				...
				float f = biomegenbase.getFloatTemperature(new BlockPos(k, 1, l));
    ...
    public Chunk provideChunk(int x, int z){
		this.frozenRNG.setSeed((long)x * 341873128712L + (long)z * 132897987541L);
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_){
		...
		biomegenbase.decorate(this.worldObj, this.frozenRNG, new BlockPos(k, 0, l));
		//boolean doGen = TerrainGen.populate(p_73153_1_, worldObj, frozenRNG, p_73153_2_, p_73153_3_, false, NETHER_LAVA);
	
		MinecraftForge.EVENT_BUS.post(new DecorateBiomeEvent.Pre(worldObj, frozenRNG, new BlockPos(k, 0, l)));
		...
		MinecraftForge.EVENT_BUS.post(new DecorateBiomeEvent.Post(worldObj, frozenRNG, new BlockPos(k, 0, l)));
