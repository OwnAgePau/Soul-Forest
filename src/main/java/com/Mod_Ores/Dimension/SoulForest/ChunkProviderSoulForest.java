...
public class ChunkProviderSoulForest implements IChunkProvider
{
    ...
    {
	this.soulRNG.setSeed((long)p_73154_1_ * 341873128712L + (long)p_73154_2_ * 132897987541L);
	...
	biomegenbase.decorate(this.worldObj, this.soulRNG, k, l);
