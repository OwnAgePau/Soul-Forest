...
public class InitMaterials {
    ...
    public static void init(){
		...
		// TODO Texture name for some reason now stored with armor material....
		Bronze_Armor = EnumHelper.addArmorMaterial("BRONZE", "soulforest:bronze", 10, new int[]{2, 6, 3, 1}, 16);
		Slime_Armor = EnumHelper.addArmorMaterial("SLIME", "soulforest:slime", 8, new int[]{2, 4, 3, 2}, 5);
		Silver_Armor = EnumHelper.addArmorMaterial("SILVER", "soulforest:silver", 12, new int[]{3, 7, 4, 2}, 23);
		Steel_Armor = EnumHelper.addArmorMaterial("STEEL", "soulforest:steel", 38, new int[]{4, 8, 6, 3}, 9);
		Cobalt_Armor = EnumHelper.addArmorMaterial("COBALT", "soulforest:cobalt", 38, new int[]{4, 8, 5, 3}, 9);
		Fyrised_Armor = EnumHelper.addArmorMaterial("FYRISED", "soulforest:fyrised", 45, new int[]{5, 9, 6, 4}, 10);
