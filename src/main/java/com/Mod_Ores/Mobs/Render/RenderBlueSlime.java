...
public class RenderBlueSlime extends RenderLiving
{
	...
	public RenderBlueSlime (RenderManager manager, ModelSlime modelSlime, ModelBase par2ModelBase, float f){
		super(manager, modelSlime, f);
     ...
     */
    protected void preRenderCallback(EntityKotek par1EntitySlime, float par2){
    ...
    protected void preRenderCallback(EntityLivingBase par1EntityLivingBase, float par2){
        this.preRenderCallback((EntityKotek)par1EntityLivingBase, par2);
    }
