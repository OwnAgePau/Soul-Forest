...
public class GenerateNether extends WorldGenerator{
    ...
    public GenerateNether(int par1, int par2){
        this(par1, par2, Blocks.stone);
    }

    public GenerateNether(int par1, int par2, Block block){
        this.minableBlockId = par1;
        this.numberOfBlocks = par2;
        this.stoneBlock = block;
    }

    public GenerateNether(int meta, int number, int target){
        this(number, target);
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2){
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D){
                            for (int i3 = k1; i3 <= j2; ++i3){
                                ...
                                Block block = par1World.getBlockState(new BlockPos(k2, l2, i3)).getBlock();
                                
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && (block != null && block.isReplaceableOreGen(par1World, new BlockPos(k2, l2, i3), BlockHelper.forBlock(Blocks.stone)))){
                                    par1World.setBlockState(new BlockPos(k2, l2, i3), block.getDefaultState());
                                }
                            }
                        }
                    }
