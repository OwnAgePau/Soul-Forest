...
public class GenerateNether extends WorldGenerator
{
    ...
    {
        this(par1, par2, Block.getBlockFromName("stone"));
    }
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int i3 = k1; i3 <= j2; ++i3)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && (block != null && block.isReplaceableOreGen(par1World, k2, l2, i3, stoneBlock)))
                                {
                                    par1World.setBlock(k2, l2, i3, block, minableBlockMeta, 2);
                                }
                            }
                        }
                    }
