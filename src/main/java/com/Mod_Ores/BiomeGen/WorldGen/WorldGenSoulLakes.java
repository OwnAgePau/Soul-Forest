            ...
            for (i1 = 0; i1 < 16; ++i1)
            {
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (i2 = 0; i2 < 8; ++i2)
                    {
                        ...
                        {
                            par1World.setBlock(par3 + i1, par4 + i2, par5 + j2, i2 >= 4 ? Block.getBlockFromName("air") : this.blockIndex, 0, 2);
                        }
                    }
                }
            }
                ...
                for (i1 = 0; i1 < 16; ++i1)
                {
                    for (j2 = 0; j2 < 16; ++j2)
                    {
                        for (i2 = 0; i2 < 8; ++i2)
                        {
                            ...
                            {
                                par1World.setBlock(par3 + i1, par4 + i2, par5 + j2, SoulBlocks.Porphyry.get(), 0, 2);
                            }
                        }
                    }
                }
            ...
            if (this.blockIndex.getMaterial() == Material.water)
            {
                for (i1 = 0; i1 < 16; ++i1)
                {
                    for (j2 = 0; j2 < 16; ++j2)
                    {
                        ...
                        {
                            par1World.setBlock(par3 + i1, par4 + b0, par5 + j2, Block.getBlockFromName("ice"), 0, 2);
                        }
                    }
                }
            }
