...
public class BlockLateriteGrass extends Block
{
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                par1World.setBlock(par2, par3, par4, SoulBlocks.LateriteDirt.get());
            }
            else if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
            {
                for (int l = 0; l < 4; ++l)
                {
                    ...
                    if (par1World.getBlock(i1, j1, k1) == SoulBlocks.LateriteDirt.get() && par1World.getBlockLightValue(i1, j1 + 1, k1) >= 4 && par1World.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
                    {
                        par1World.setBlock(i1, j1, k1, SoulBlocks.LateriteDirt.get());
                    }
                }
            }
        }
