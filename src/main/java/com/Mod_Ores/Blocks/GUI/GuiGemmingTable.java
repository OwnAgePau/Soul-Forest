...
public class GuiGemmingTable extends GuiContainer{	
    public static final ResourceLocation TEXTURE = new ResourceLocation("textures/gui/container/furnace.png");
    
    public GuiGemmingTable(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5){
        super(new ContainerGemming(par1InventoryPlayer, par2World, par3, par4, par5));
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2){
        this.fontRendererObj.drawString("Gemming Table", 54, 6, 0x000000);
