...
public class BlockBogTallGrassPurple extends BlockFlower implements IScollectable
{
    private static final String[] grassTypes = new String[] {"Bog_grass_tall_purple"};
    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;

    public BlockBogTallGrassPurple(String Unlname)
    {
	super(0);
	float f = 0.4F;
     ...
     */
    public int idDropped(int id, Random par2Random, int quantity)
    {
	return -1;
    }
    ...
    {
	int quantity;
	if(par1Random.nextInt(5) == 1)
	{
	    quantity = 1;
	    //this.idDropped(SoulConfigItems.frozenRodID, par1Random, quantity);
	    return super.quantityDropped(par1Random);
	}

	par1Random.nextInt(0);
	return super.quantityDropped(par1Random);
    }
	...
	{
	    this.iconArray[i] = par1IconRegister.registerIcon("soulforest:Bog_grass_tall_purple");
	}
    }
    ...
    @Override
    public boolean isCollectable(ItemStack item, World world, int x, int y,
	    int z) {
	return true;
    }

    @Override
    public ArrayList<ItemStack> onCollected(ItemStack item, World world, int x,
