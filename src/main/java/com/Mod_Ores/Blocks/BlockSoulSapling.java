...
public class BlockSoulSapling extends BlockFlower
{
	...
	for (int i = 0; i < 2; ++i){
	    this.saplingIcon[i] = par1IconRegister.registerIcon(soul_forest.MODID + ":" + this.saplingName);
	}
    }
}
