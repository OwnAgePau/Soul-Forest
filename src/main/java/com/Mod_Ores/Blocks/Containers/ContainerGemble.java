...
public class ContainerGemble extends Container{
	...
	return this.worldObj.getBlock(this.posX, this.posY, this.posZ) != SoulBlocks.GembleTable.get() ? false : par1EntityPlayer.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
    }
