...
public class ContainerGemble extends Container{
    ...
    public ContainerGemble(InventoryPlayer par1InventoryPlayer, World world, int x, int y, int z){
		this.worldObj = world;
		this.posX = x;
		this.posY = y;
		this.posZ = z;
		this.addSlotToContainer(new SlotGembleCrafting(par1InventoryPlayer.player, this.craftMatrix, this.craftResult, 0, 116, 35));
		int l;
		int i1;
    ...
    public void onCraftMatrixChanged(IInventory par1IInventory){
		ItemStack result = GembleCraftingRecipes.getInstance().findMatchingRecipe(this.craftMatrix, this.worldObj);
    ...
    public boolean canInteractWith(EntityPlayer par1EntityPlayer){
    	return this.worldObj.getBlockState(new BlockPos(this.posX, this.posY, this.posZ)).getBlock() != SoulBlocks.GembleTable.get() ? false : par1EntityPlayer.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
    }
