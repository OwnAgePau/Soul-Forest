...
public class GemmingCraftingRecipes{
     ...
     */
    public static final GemmingCraftingRecipes getInstance(){
        return instance;
    }
     ...
     * 
     */
    private GemmingCraftingRecipes(){
    	for(ItemSoulPickaxe pickaxe : InitItems.soulPickaxes){
	    this.addShapelessRecipe(new ItemStack(pickaxe, 1), new Object[] {SoulItems.ScarletiteAmuletStone.get(), pickaxe});   
	}
	for(ItemSoulAxe axe : InitItems.soulAxes){
	    this.addShapelessRecipe(new ItemStack(axe, 1), new Object[] {SoulItems.ScarletiteAmuletStone.get(), axe});   
	}
	for(ItemSoulHoe hoe : InitItems.soulHoes){
	    this.addShapelessRecipe(new ItemStack(hoe, 1), new Object[] {SoulItems.ScarletiteAmuletStone.get(), hoe});   
	}
	for(ItemSoulShovel shovel : InitItems.soulShovels){
	    this.addShapelessRecipe(new ItemStack(shovel, 1), new Object[] {SoulItems.ScarletiteAmuletStone.get(), shovel});   
	}
	for(ItemSoulSword sword : InitItems.soulSwords){
	    this.addShapelessRecipe(new ItemStack(sword, 1), new Object[] {SoulItems.ScarletiteAmuletStone.get(), sword});   
	}
	for(ItemWarAxe warAxe : InitItems.soulWarAxes){
	    this.addShapelessRecipe(new ItemStack(warAxe, 1), new Object[] {SoulItems.ScarletiteAmuletStone.get(), warAxe});   
	}	
	for(ItemArmor armor : InitItems.soulArmors){
	    this.addShapelessRecipe(new ItemStack(armor, 1), new Object[] {SoulItems.ScarletiteAmuletStone.get(), armor});   
	}
	
	this.addShapelessRecipe(new ItemStack(SoulItems.BerryCollector.get(), 1), new Object[] {SoulItems.ScarletiteAmuletStone.get(), SoulItems.BerryCollector.get()});   
	
    	Collections.sort(this.recipes, new GemmingTableRecipeSorter(this));
    }
