...
public class RenderTinThrowingKnife extends Render{
	...
	protected RenderTinThrowingKnife(RenderManager renderManager) {
		super(renderManager);
	}
     ...
     */
	public void renderTinThrowingKnife(EntityTinThrowingKnife entity, double x, double y, double z, float entityYaw, float partialTicks){
