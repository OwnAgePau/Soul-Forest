...
public class RenderCopperThrowingKnife extends Render
{
     ...
     */
    public void renderCopperThrowingKnife(EntityCopperThrowingKnife par1EntityCopperThrowingKnife, double par2, double par4, double par6, float par8, float par9)
    {
    	Entity fb = (EntityCopperThrowingKnife)par1EntityCopperThrowingKnife;
    	double xzSize = par1EntityCopperThrowingKnife.boundingBox.maxX -par1EntityCopperThrowingKnife.boundingBox.minX;
    	double ySize = par1EntityCopperThrowingKnife.boundingBox.maxY-par1EntityCopperThrowingKnife.boundingBox.minY;
        GL11.glPushMatrix();
        ...
        tessellator.draw();
        GL11.glPopMatrix();
        /*this.func_110777_b(par1EntityCopperThrowingKnife);
        GL11.glPushMatrix();
        GL11.glTranslatef((float)par2, (float)par4, (float)par6);
        Minecraft.getMinecraft().renderEngine.func_110577_a(CommonProxy.FrostShard);
        GL11.glRotatef(par1EntityCopperThrowingKnife.prevRotationYaw + (par1EntityCopperThrowingKnife.rotationYaw - par1EntityCopperThrowingKnife.prevRotationYaw) * par9 - 90.0F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(par1EntityCopperThrowingKnife.prevRotationPitch + (par1EntityCopperThrowingKnife.rotationPitch - par1EntityCopperThrowingKnife.prevRotationPitch) * par9, 0.0F, 0.0F, 1.0F);
        Tessellator tessellator = Tessellator.instance;
        byte b0 = 0;
        float f2 = 0.0F;
        float f3 = 0.5F;
        ...
        float f11 = (float)par1EntityCopperThrowingKnife.arrowShake - par9;
